        ...
        {totalVideos === 0 ? (
          ...
          <>
            ...
            <div style={{
              ...
              padding: 28, marginBottom: 24, boxShadow: "0 1px 4px rgba(0,0,0,0.05), 0 0 16px rgba(200, 68, 42, 0.2)",
            }}>
              <h2 style={{
              ...
              {videos.map(video => {
                ...
                return (
                  <div key={video.id} style={{
                    background: B.surface, border: '1px solid rgba(200, 68, 42, 0.7)', borderRadius: 16,
                    padding: "20px 24px", boxShadow: "0 1px 4px rgba(0,0,0,0.04), 0 0 16px rgba(200, 68, 42, 0.2)",
                  }}>
                    <div style={{
